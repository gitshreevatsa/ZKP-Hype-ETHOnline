...
contract TestSender{
    ...
    function sendProof(uint16 _dest, address _receipient, bytes calldata _proof, bytes32[] calldata _publicInputs) external payable{
        bytes memory payload = abi.encode(_proof, _publicInputs);
